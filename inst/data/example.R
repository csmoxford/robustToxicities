...
data = read.csv("inst/data/Fake_data.csv", stringsAsFactors = FALSE)
...
cycleLabels = c("Rgistration", "Randomisation","Cycle 1", "Cycle 2", "Cycle 3", "Cycle 4", "Cycle 5", "Cycle 6")
...
print_toxTable_cycle(toxDB, cycles = 8 )
